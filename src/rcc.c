...
Bit 0 des RCC_CR Registers eine 1 schreiben. Für den zweiten Schritt müssen
wir darauf warten, dass Bit 1 des RCC_CR Registers von der Hardwareseite aus
auf 1 gesetzt wird. Wir können also auf Bit 1 nur lesend zugreifen. Für 
Schritte drei und vier benötigen wir ein weiteres Register: das RCC clock 
...
entsprechend 5 WS für den Flash-Speicher konfigurieren müssen. Laut Seite 56ff
in [1] kann dies über das "Flash access control register" (FLASH_ACR) erfolgen.
